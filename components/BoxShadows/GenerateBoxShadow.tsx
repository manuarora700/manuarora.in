        ...
        <div className="w-full lg:w-[60%]">
          <div className="relative flex  flex-col justify-center  py-6 sm:py-12">
            ...
            <div
              ...
              className="relative bg-white px-6 pt-10 pb-8  ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-lg sm:rounded-lg sm:px-10"
            >
              <div className="mx-auto max-w-md">
                ...
                <div className="divide-y divide-gray-300/50">
                  ...
                  <div className="pt-8 text-base font-semibold leading-7">
                    <p className="text-gray-900">Want beautiful shadows already?</p>
                    <p>
                      <button
